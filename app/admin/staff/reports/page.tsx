...
export default function AdminReportsPage() {
  ...
  const handleSave = () => {
    console.log("Saving reports:", { selectedShow, reports });
    alert("Reports saved!");
  };
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-md mx-auto text-white">
        ...
        {/* Upload Reports */}
        <h2 className="text-lg font-semibold mb-2">Upload Report (PDF)</h2>
        <input
          type="file"
        ...
        <div className="space-y-2 mb-6">
          {reports.length === 0 && (
            <p className="text-sm opacity-70">No reports uploaded yet.</p>
          )}
          {reports.map((report) => (
            <div
              key={report.id}
