...
const keyContacts: KeyContact[] = [
  { role: "Stage Manager", name: "John Smith", phone: "555-111-2222" },
  { role: "ASM", name: "Mary Johnson", phone: "555-333-4444" },
  { role: "Company Manager", name: "Robert Green", phone: "555-555-6666" },
...
const contactDocs = [
  {
    id: "1",
    name: "Full Contact Sheet",
    url: "/docs/full-contacts.pdf",
...
export default function ContactsPage() {
  return (
    <main className="min-h-screen bg-gradient-to-b from-black via-red-900 to-black text-white px-6 py-10">
      <h1 className="text-2xl font-bold text-center mb-6">The Wonderful Winter of Oz Contacts</h1>
